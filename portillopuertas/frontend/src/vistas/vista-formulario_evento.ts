...
<vaadin-vertical-layout style="width: 100; height: 100%; background:#D3E0EA; align-items: flex-start;">
 ...
 <vaadin-select value="Item one" style="margin-left: var(--lumo-space-l); margin-top: var(--lumo-space-m);" label="Tipo" id="tipo">
  <template>
   <vaadin-list-box selected="0" id="vaadinListBox">
    <vaadin-item selected id="primerItem">
      Festival 
    </vaadin-item>
    <vaadin-item id="segundoItem">
      Concierto 
    </vaadin-item>
    <vaadin-item id="tercerItem">
      Festival 2 
    </vaadin-item>
   </vaadin-list-box>
  </template>
 ...
 <vaadin-button style="align-self: flex-end; margin: var(--lumo-space-m);" id="vaadinButton">
   Publicar Evento 
 </vaadin-button>
