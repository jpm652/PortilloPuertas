...
<vaadin-vertical-layout style="width: 100%; background:#276678; height: 10%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout class="header" style="width: 100%; flex-basis: var(--lumo-size-l); flex-shrink: 0; justify-content: space-between; height: 100%; align-items: center;" id="vaadinHorizontalLayout">
  <img style="align-self: baseline; width: 150px; height: 100%; flex-grow: 0;" src="https://github.com/JLPortillo-UAL/PPMusic/blob/main/assets/images/logoSoundCity.png?raw=true" id="img_cabecera_registrado">
