...
@customElement('vista-busqueda_playlist')
export class VistaBusqueda_playlist extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout theme="spacing" id="vaadinHorizontalLayout" style="width: 100%;">
  <label id="label" style="margin-top: 20px; margin-left: 50px;font-size:20px;font-weight:bold">PlayList</label>
