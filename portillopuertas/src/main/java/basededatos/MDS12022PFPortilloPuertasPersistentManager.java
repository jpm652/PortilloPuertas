...
public class MDS12022PFPortilloPuertasPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS12022PFPortilloPuertas";
	...
	private MDS12022PFPortilloPuertasPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.UsuarioComun.class);
		...
		aMetadataSources.addAnnotatedClass(basededatos.Playlist.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS12022PFPortilloPuertasPersistentManager();
		}
