...
public class CreateMDS12022PFPortilloPuertasData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : contiene_canciones, pertenece_a_artista
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : es_reproducida_por, pertenece_a_playlist, pertenece_a_album, numReproducciones, estilo, duracion, pertenece_a_estilo
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : crea_playlist, reproduce_cancion, seguidos, seguidores
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : publica_eventos, crea_album
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : contiene_canciones, creada_por_usuario
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : contiene_cancion
